...
import './OccupiedHostelsPage.scss'
...
const OccupiedHostelsPage = () => {
  // Filter the hostels to get only the occupied ones
  const occupiedHostels = hostels.filter((hostel) => hostel.occupied);
  ...
  return (
    <div className='home'>
      ...
      <div className="homeContainer">
        <Navbar/>
        <div>
        <h1>Occupied Hostels</h1>
      <ul>
        {occupiedHostels.map((hostel) => (
          <li key={hostel.id}>
...
export default OccupiedHostelsPage;
